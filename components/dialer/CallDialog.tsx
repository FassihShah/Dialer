        ...
        <div className={cn('px-6 py-4 flex items-center justify-between flex-shrink-0 transition-colors', headerBg)}>
          <div>
            <div className="flex items-center gap-3">
              ...
              {callStatus === 'connected' && <><span className="relative flex w-2.5 h-2.5"><span className="absolute inline-flex h-full w-full rounded-full bg-green-400 animate-pulse-ring" /><span className="relative inline-flex w-2.5 h-2.5 rounded-full bg-green-500" /></span><span className="text-green-700 font-bold text-sm font-dm uppercase tracking-wider">CONNECTED</span><span className="text-navy font-mono font-bold text-lg tabular-nums">{formatTimer(callDuration)}</span></>}
